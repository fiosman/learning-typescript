...
console.log(`Further down on the left is: ${adjacentLeft !== null && adjacentLeft !== void 0 ? adjacentLeft : "nobody"}`);
console.log(`Further down on the right is: ${adjacentRight !== null && adjacentRight !== void 0 ? adjacentRight : "nobody"}`);
